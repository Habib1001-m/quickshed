...
export const metadata: Metadata = {
  ...
  description:
    'Free, privacy-respecting web toolbox with 90 tools that run entirely in your browser. Tool inputs and files stay in your browser; the application does not transmit them off-device.',
  ...
  openGraph: {
    ...
    description: 'Free, privacy-respecting web toolbox with 90 browser-based tools. Tool inputs and files stay in your browser.',
    siteName: 'QuickShed',
    type: 'website',
    url: SITE_URL,
