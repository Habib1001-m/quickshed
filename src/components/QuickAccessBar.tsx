  ...
  return (
    <>
      {!isMinimized && (
        <div
          aria-hidden="true"
          className="quick-access-layout-reserve"
          data-testid="quick-access-layout-reserve"
        />
      )}
      <AnimatePresence>
        {isMinimized ? (
          ...
          <motion.div
            ...
            className="quick-access-bar fixed bottom-0 inset-x-0 z-40 border-t border-border/40 bg-background/80 backdrop-blur-xl"
            dir={isRtl ? 'rtl' : 'ltr'}
            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              ...
              <div className="flex items-center justify-between py-2">
                ...
                <button
                  ...
                  data-testid="quick-access-minimize"
                >
